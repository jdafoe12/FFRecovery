...
class App:
    ...
    def recover(self):
        ...
        #print("umount a file system")
        #os.system("umount /dev/sdb")
        #os.system("sudo dd if=/dev/zero of=/dev/sdb bs=512 count=1 seek=951388")
        #print("mount a file system")
        #os.system("mount /dev/sdb /home/john/Desktop/f")
        #nc test ends
