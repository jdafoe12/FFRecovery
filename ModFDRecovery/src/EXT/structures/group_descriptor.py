...
class GroupDescriptor:
    ...
    def __init__(self, diskO: disks.Disk, groupNum: int, superBlock: super_block.SuperBlock):
        ...
        """
        # A byte offset from the start of disk to the first block (in group 1) containing group descriptors.0
        superBlockBlocks = ceil(2048 / superBlock.blockSize)
        groupDescriptorTableOffSet = (superBlock.blockSize * (superBlock.blocksPerGroup + superBlockBlocks))
