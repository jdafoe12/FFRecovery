...
#define SECTOR_PER_PAGE             (1<<SECTOR_PER_PAGE_SHIFT)//4
#define PAGE_SIZE                   (SECTOR_SIZE*SECTOR_PER_PAGE)
#define SECTOR_PER_MPP              (SECTOR_PER_PAGE*PLANE_PER_DIE)//4
#define SECTOR_PER_MPP_SHIFT        (SECTOR_PER_PAGE_SHIFT+PLANE_PER_DIE_SHIFT)//2
...
#define SPARE_WORDS_IN_PAGE      (SPARE_BYTES_IN_PAGE/sizeof(UINT32))//2
...
typedef enum {
   ...
   //jsjpenn
   STATUS_Remount,//改变状态
   STATUS_MTDEraseReturnFail,//物理擦除返回失败
