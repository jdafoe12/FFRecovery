...
#pragma inline
BOOL_32 USB_ReqSetClrFeature(UNS_32 sc) {
  UNS_32 n, m;
...
#pragma inline
BOOL_32 USB_ReqSetAddress(void) {
...
#pragma inline
BOOL_32 USB_ReqGetDescriptor(void) {
  UNS_8 *pD;
  UNS_32 len, n;
...
#pragma inline
BOOL_32 USB_ReqGetConfiguration(void) {
  switch (SetupPacket.bmRequestType.BM.Recipient) {
    case REQUEST_TO_DEVICE:
...
#pragma inline
BOOL_32 USB_ReqSetConfiguration(void) {
          ...
          switch (pD->bDescriptorType) {
            case USB_CONFIGURATION_DESCRIPTOR_TYPE:
              if (((USB_CONFIGURATION_DESCRIPTOR *) pD)->bConfigurationValue
                ...
                USB_NumInterfaces = ((USB_CONFIGURATION_DESCRIPTOR *) pD)
                    ->bNumInterfaces;
...
#pragma inline
BOOL_32 USB_ReqGetInterface(void) {
  switch (SetupPacket.bmRequestType.BM.Recipient) {
    case REQUEST_TO_INTERFACE:
      if ((USB_Configuration != 0)
          && (SetupPacket.wIndex.WB.L < USB_NumInterfaces)) {
...
#pragma inline
BOOL_32 USB_ReqSetInterface(void) {
  USB_COMMON_DESCRIPTOR *pD;
...
//                    case AUDIO_REQUEST_SET_RES:
                ...
                out_class_ok:
#endif
                /* request finished successfully *//* request finished successfully */
                break; /* end case REQUEST_CLASS */
#endif  /* USB_CLASS */
